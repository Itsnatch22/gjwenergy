                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <div
                      role="button"
                      tabIndex={0}
                      className={`group relative flex h-full min-h-104 w-full cursor-pointer flex-col justify-between overflow-hidden p-8 text-left lg:p-10 ${
                        s.theme === "light"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <Reveal className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-16">
            ...
            <figure className="lg:col-span-5">
              <div className="relative h-80 overflow-hidden lg:h-104">
                <img loading="lazy" decoding="async"
